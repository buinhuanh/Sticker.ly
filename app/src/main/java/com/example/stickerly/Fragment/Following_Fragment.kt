...
import com.example.stickerly.databinding.FragmentFollowingBinding
 ...
 * Use the [Following_Fragment.newInstance] factory method to
...
class Following_Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        viewModel.stickerSecond.observe(viewLifecycleOwner, Observer {
            binding.viewFollwing.layoutManager=LinearLayoutManager(requireContext(),LinearLayoutManager.VERTICAL,false)
            binding.viewFollwing.adapter=StickerAdapter(it)
        })
